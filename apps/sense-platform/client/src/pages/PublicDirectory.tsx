...
export default function PublicDirectory() {
  ...
  const title = isProviders ? "كتالوج المزودين المنشور" : isMunicipal ? "الخدمات والبلاغات البلدية" : isServices ? "الخدمات المنشورة من المزودين" : "دليل الوجهات الموثقة";
  const intro = isProviders ? "هذه الصفحة تعرض فقط العناصر التي نشرها مزود داخل SENSE. افتح بطاقة العنصر لمراجعة الوصف وبيانات الوصول ونطاق الخدمة قبل التواصل أو إنشاء طلب." : isMunicipal ? "قدّم بلاغًا أو طلبًا بلديًا، وأرفق الموقع والوصف والصور عند الحاجة، ثم تابع الحالة من حسابك. لا تُعرض هنا حالة تنفيذ غير مسجلة في النظام." : isServices ? "تصفح الخدمات التي أضيفت إلى كتالوج SENSE، وميّز بين الوصف المنشور والمعلومات التي ما زالت تحتاج مراجعة قبل طلبها." : "يعرض الدليل الوجهات التي سُجل لها مصدر عام وتاريخ تحقق وجهة مسؤولة. عندما لا تتوفر هذه البيانات، تبقى الوجهة خارج النتائج بدل تقديم معلومة غير مؤكدة.";
